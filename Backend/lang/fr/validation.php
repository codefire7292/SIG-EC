...
return [
    ...
    'contains' => 'Le champ :attribute requiert la valeur :value.',
    ...
    'max_width' => 'Le champ :attribute ne doit pas avoir une largeur supérieure à :max pixels.',
    'max_height' => 'Le champ :attribute ne doit pas avoir une hauteur supérieure à :max pixels.',
    ...
    'min_width' => 'Le champ :attribute doit avoir une largeur d\'au moins :min pixels.',
    'min_height' => 'Le champ :attribute doit avoir une hauteur d\'au moins :min pixels.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Le mot de passe :attribute est apparu dans une fuite de données. Veuillez choisir un autre :attribute.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'health_facility' => 'structure de santé',
        'act_registration_date' => 'date d\'enregistrement',
        'gender' => 'sexe',
        'is_judgment' => 'sur jugement',
        'judgment_number' => 'numéro du jugement',
        'judgment_date' => 'date du jugement',
        ...
        'certificate_file' => 'fichier de l\'acte',
        'certificate_path' => 'chemin de l\'acte',
        
        // Parents metadata
        'parents_metadata.father_profession' => 'profession du père',
        'parents_metadata.father_date_of_birth' => 'date de naissance du père',
        'parents_metadata.father_place_of_birth' => 'lieu de naissance du père',
        'parents_metadata.father_domicile' => 'domicile du père',
        'parents_metadata.mother_profession' => 'profession de la mère',
        'parents_metadata.mother_date_of_birth' => 'date de naissance de la mère',
        'parents_metadata.mother_place_of_birth' => 'lieu de naissance de la mère',
        'parents_metadata.mother_domicile' => 'domicile de la mère',
        'parents_metadata.declarant_first_name' => 'prénom du déclarant',
        'parents_metadata.declarant_last_name' => 'nom du déclarant',
        'parents_metadata.declarant_profession' => 'profession du déclarant',
        'parents_metadata.declarant_address' => 'adresse du déclarant',
        'parents_metadata.declarant_id_number' => 'numéro de pièce du déclarant',
        'parents_metadata.declarant_date' => 'date de déclaration',
        'parents_metadata.witnesses.*.first_name' => 'prénom du témoin',
        'parents_metadata.witnesses.*.last_name' => 'nom du témoin',
        'parents_metadata.witnesses.*.date_of_birth' => 'date de naissance du témoin',
        'parents_metadata.witnesses.*.place_of_birth' => 'lieu de naissance du témoin',
