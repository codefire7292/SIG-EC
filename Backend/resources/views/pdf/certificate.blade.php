...
<body>
    ...
    <div class="content-box">
        ...
        <div style="margin-top: 30px;">
            <div class="section">
                ...
                <span class="value">{{ $certificate->applicant_first_name }}
                    {{ $certificate->applicant_last_name }}</span>
            </div>
    ...
    <div class="footer">
        <div class="signature-box">
            <div class="label">Fait à {{ $certificate->center }}, le
                {{ $certificate->validated_at?->format('d/m/Y') ?? now()->format('d/m/Y') }}</div>
            @if(!empty($mayor_signature))
                <div style="margin-top: 5px; margin-bottom: -55px;">
                    <img src="data:image/png;base64,{{ $mayor_signature }}" style="max-height: 120px; max-width: 300px;">
                </div>
            @endif
