            ...
            <div class="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl shadow-blue-100 border border-gray-50 overflow-hidden relative">
                ...
                <div class="p-10 md:p-12">
                    <div class="mb-10 text-center">
                        <h1 class="text-3xl font-black text-gray-900 tracking-tighter mb-2 font-sans">Nouveau Code</h1>
                        <p class="text-gray-500 font-medium font-sans">Définissez votre nouveau mot de passe.</p>
                    </div>
