...
<template>
    <Head title="Validation de ma Progression" />
    ...
    <AuthenticatedLayout>
        <div class="max-w-4xl mx-auto py-8 px-4">
            <header class="mb-8">
                ...
                <p class="text-gray-500">Confirmer la réalisation des chapitres dispensés par votre formateur pour le groupe <strong>{{ group.nom_groupe }}</strong>.</p>
            </header>
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4 mt-1">
                                <p class="text-xs text-gray-400">Soumis par : <span class="text-gray-600 font-bold">{{ item.submitter.name }} (Formateur)</span></p>
